...
const styles = StyleSheet.create({
  ...
  contentWrap: { flex: 1, width: '100%', maxWidth: 500, alignSelf: 'center', ...(Platform.OS === 'web' ? { paddingVertical: 32 } : {}) },
  topSection: { paddingHorizontal: 24, paddingBottom: 24, alignItems: 'center', position: 'relative' },
  backBtn: { position: 'absolute', top: Platform.OS === 'web' ? 40 : 20, left: 24, flexDirection: 'row', alignItems: 'center', gap: 6, zIndex: 10, padding: 8 },
  ...
  formWrapper: { flex: 1, backgroundColor: Colors.surface, borderTopLeftRadius: 28, borderTopRightRadius: 28, ...(Platform.OS === 'web' ? { borderRadius: 28, maxHeight: 680, shadowColor: '#000', shadowOffset: { width: 0, height: 12 }, shadowOpacity: 0.1, shadowRadius: 24 } : {}) },
