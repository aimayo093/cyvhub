...
const QUICK_PROMPTS = [
  { label: 'My earnings this week', icon: CreditCard, query: 'How much have I earned this week?' },
  { label: 'Active delivery status', icon: Truck, query: 'What is the status of my active jobs?' },
  { label: 'Upcoming schedule', icon: Clock, query: 'Show my schedule for tomorrow' },
  { label: 'My SLA performance', icon: TrendingUp, query: 'What is my on-time delivery rate?' },
  { label: 'Route map help', icon: Map, query: 'Help me with my current route' },
];

export default function DriverAIScreen() {
      ...
      >
        {messages.length === 0 && (
          <View style={styles.welcomeSection}>
            ...
            <Text style={styles.welcomeTitle}>Driver AI Assistant</Text>
            <Text style={styles.welcomeSub}>
              Ask me about your deliveries, earnings, schedule, or performance. I'm here to help you on the road.
            </Text>
            ...
            <View style={styles.promptsGrid}>
              {QUICK_PROMPTS.map((prompt) => (
                <TouchableOpacity
                  ...
                  activeOpacity={0.7}
                >
                  <prompt.icon size={16} color={Colors.primary} />
        ...
        {isTyping && (
          <Animated.View style={[styles.typingIndicator, { opacity: typingAnim.interpolate({ inputRange: [0, 1], outputRange: [0.4, 1] }) }]}>
            ...
            <Text style={styles.typingText}>Checking your data...</Text>
          </Animated.View>
        )}
